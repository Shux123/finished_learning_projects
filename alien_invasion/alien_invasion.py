...
class AlienInvasion:
    ...
    def __init__(self):
        '''Initialize game and create a game resourses.'''
        pygame.init()
    ...
    def _check_play_button(self, mouse_pos):
        #Starts a new game when player clicks play button
    ...
    def _update_aliens(self):
        ...
        #Check if the fleet is at edge and change direction
        ...
        #Look for alien hitting the bottom of the schreen
        self._check_aliens_bottom()

    def _ship_hit(self):
        #Responce to the ship being hit by an alien
    ...
    def _check_aliens_bottom(self):
        #Check if any aliens riched the bottom of the screen
    ...
    def _update_screen(self):
        #Update image on the screen and flip display.
